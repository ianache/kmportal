...
<required_reading>
@D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode
                  → checks D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done
                  → writes to D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/hooks/
...
@D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/references/common-bug-patterns.md
