...
Use template from `D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/templates/UI-SPEC.md`
