...
<required_reading>
Read `D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
