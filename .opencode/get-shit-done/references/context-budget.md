...
The keys live in `.claude/settings.json` (project) or `D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
