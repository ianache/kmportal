...
Key references:
- @D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/USER-PROFILE.md" "D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/AGENTS.md
```
