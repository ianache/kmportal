...
```
Task(
  prompt="Read D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/templates/SECURITY.md`
