...
```bash
INIT=$(node "D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
