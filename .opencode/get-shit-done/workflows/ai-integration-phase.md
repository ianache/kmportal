...
<required_reading>
@D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/references/ai-frameworks.md
@D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.opencode/agents/gsd-eval-planner.md for instructions.
