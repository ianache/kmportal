...
- Usage: Reference from command with `@D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
