...
```markdown
Read D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/agents/gsd-ui-checker.md for instructions.
