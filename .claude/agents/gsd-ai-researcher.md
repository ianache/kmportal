...
<required_reading>
Read `D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
