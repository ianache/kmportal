...
- @D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/get-shit-done/workflows/complete-milestone.md (main workflow)
- @D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
