...
Read and execute `D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/get-shit-done/workflows/discuss-phase-assumptions.md` end-to-end.

If `DISCUSS_MODE` is `"discuss"` (or unset, or any other value):
Read and execute `D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/get-shit-done/workflows/discuss-phase.md` end-to-end.
