...
<execution_context>
@D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.claude/get-shit-done/workflows/docs-update.md end-to-end.
