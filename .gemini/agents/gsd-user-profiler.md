...
<reference>
@D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.gemini/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.gemini/get-shit-done/references/user-profiling.md` to load:
