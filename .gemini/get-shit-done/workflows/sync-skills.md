...
INSTALL_JS_GLOBAL="D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.gemini/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.gemini/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
