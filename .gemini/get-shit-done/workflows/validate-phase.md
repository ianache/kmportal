...
```
Task(
  prompt="Read D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/02-PERSONAL/01-PROJECTS/25-KnowledgeManagement/.gemini/get-shit-done/templates/VALIDATION.md`
